//app/(admin)/admin/work/add-work/page.js
...
export default function AddWorkPage() {
  ...
  // ✅ Check query param
  useEffect(() => {
    const hasFeatured = searchParams.get("hasFeaturedWork") === "true";
    if (hasFeatured) {
      setFormData((prev) => ({
        ...prev,
    ...
    <div className="max-w-[1080px] mx-auto py-12">
      ...
      >
        <div className="w-full flex flex-col gap-4 md:max-w-[640px] relative">
          <div className="w-full flex flex-row justify-between items-center">
            <span className="font-archivo font-semibold text-base text-[#5f5f5f]">
              Author: <span className="font-normal">{session?.user?.name}</span>
            </span>
            <span className="font-archivo font-semibold text-base text-[#5f5f5f]">
                  ...
                  >
                    <button
                      ...
                      onClick={() =>
                        setFormData((prev) => ({
                          ...prev,
                          slider1: prev.slider1.filter((_, i) => i !== idx),
                        }))
                      }
                  ...
                  >
                    <button
                      ...
                      onClick={() =>
                        setFormData((prev) => ({
                          ...prev,
                          slider2: prev.slider2.filter((_, i) => i !== idx),
                        }))
                      }
                      className="absolute -top-2 -right-2 bg-red-500 text-white cursor-pointer rounded-full w-6 h-6 flex items-center justify-center"
                    >
        ...
        <div className="w-full md:max-w-[400px] flex flex-col gap-4">
          <div className="w-full p-[6px] bg-[#EEEEEE] rounded-2xl">
                ...
                <div className="w-full flex flex-col gap-2.5">
                  <div className="w-full flex flex-row justify-between items-center ps-3">
                    ...
                    <input
                      ...
                      hidden
                      onChange={(e) =>
                        handleMultiFileChange(e, "featuredImages")
                      }
                    />
                  </div>
                        ...
                        >
                          <button
                            ...
                            onClick={() =>
                              setFormData((prev) => ({
                                ...prev,
                                featuredImages: prev.featuredImages.filter(
                                  (_, i) => i !== idx
                                ),
                              }))
                            }
