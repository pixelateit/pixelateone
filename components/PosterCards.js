...
export default function PosterCards() {
  ...
  return (
    <div className="w-full h-[1080px] relative" ref={divW}>
      <div
        className="w-fit absolute translate-[-50%, -50%] rounded-[1px] bg-black z-14"
        ref={post1}
        style={{
          boxShadow: "0px 32px 64px -12px #000000CC",
        }}
      >
        <Image
          src={Posters[0]}
          alt={`Poster 1`}
          priority
          className="aspect-auto grow rounded-[1px]"
          style={{ maxWidth: "clamp(135px, 14vw, 270px)" }}
        />
      </div>

      <div
        className="w-fit absolute translate-[-50%, -50%] rounded-[1px] bg-black z-12"
        ref={post2}
        style={{
          boxShadow: "0px 32px 64px -12px #000000CC",
        }}
      ...
      <div
        className="w-fit absolute translate-[-50%, -50%] rounded-[1px] bg-black z-11"
        ref={post3}
        style={{
          boxShadow: "0px 32px 64px -12px #000000CC",
        }}
      ...
      <div
        className="w-fit absolute translate-[-50%, -50%] rounded-[1px] bg-black z-10"
        ref={post4}
        style={{
          boxShadow: "0px 32px 64px -12px #000000CC",
        }}
      ...
      <div
        className="w-fit absolute translate-[-50%, -50%] rounded-[1px] bg-black z-9"
        ref={post5}
        style={{
          boxShadow: "0px 32px 64px -12px #000000CC",
        }}
      ...
      <div
        className="w-fit absolute translate-[-50%, -50%] rounded-[1px] bg-black z-8"
        ref={post6}
        style={{
          boxShadow: "0px 32px 64px -12px #000000CC",
        }}
      ...
      <div
        className="w-fit absolute translate-[-50%, -50%] rounded-[1px] bg-black z-6"
        ref={post7}
        style={{
          boxShadow: "0px 32px 64px -12px #000000CC",
        }}
      ...
      <div
        className="w-fit absolute translate-[-50%, -50%] rounded-[1px] bg-black z-5"
        ref={post8}
        style={{
          boxShadow: "0px 32px 64px -12px #000000CC",
        }}
      ...
      <div
        className="w-fit absolute translate-[-50%, -50%] rounded-[1px] bg-black z-4"
        ref={post9}
        style={{
          boxShadow: "0px 32px 64px -12px #000000CC",
        }}
      ...
      <div
        className="w-fit absolute translate-[-50%, -50%] rounded-[1px] bg-black z-3"
        ref={post10}
        style={{
          boxShadow: "0px 32px 64px -12px #000000CC",
        }}
      ...
      <div
        className="w-fit absolute translate-[-50%, -50%] rounded-[1px] bg-black z-2"
        ref={post11}
        style={{
          boxShadow: "0px 32px 64px -12px #000000CC",
        }}
      ...
      <div
        className="w-fit absolute translate-[-50%, -50%] rounded-[1px] bg-black z-1"
        ref={post12}
        style={{
          boxShadow: "0px 32px 64px -12px #000000CC",
        }}
      ...
      <div
        className="w-fit absolute translate-[-50%, -50%] rounded-[1px] bg-black z-13"
        ref={post13}
        style={{
          boxShadow: "0px 32px 64px -12px #000000CC",
        }}
      ...
      <div
        className="w-fit absolute translate-[-50%, -50%] rounded-[1px] bg-black z-7"
        ref={post14}
        style={{
          boxShadow: "0px 32px 64px -12px #000000CC",
        }}
